...
void CSceneManager::Initialize()
{
	...
	m_arrScene[(UINT)SCENE_TYPE::TUTORIAL] = new CSceneStart;
	m_arrScene[(UINT)SCENE_TYPE::TUTORIAL]->SetName(L"CScene Start");
	...
	m_arrScene[(UINT)SCENE_TYPE::STAGE_07] = new Stage7;
	m_arrScene[(UINT)SCENE_TYPE::STAGE_07]->SetName(L"Stage7");
